    ...
    <form onSubmit={submitHandler} className="w-full max-w-sm mx-auto">
      <div className="mt-10 flex">
        ...
        <input
          ...
          className="form-input block w-full py-2 px-5 border border-blue-300 
        ...
        <button
          type="submit"
          className="ml-2 py-2 px-3 border border-blue-300 rounded-md text-sm 
          leading-3 font-large text-gray-700 hover:text-gray-500 focus:outline-none
